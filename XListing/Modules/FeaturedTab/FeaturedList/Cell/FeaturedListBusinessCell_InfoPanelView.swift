...
public final class FeaturedListBusinessCell_InfoPanelView : UIView {
    ...
    private lazy var priceIconImageView: UIImageView = {
        ...
        // FIXME: wrong icon
        imageView.pin_updateUIWithImage(UIImage(asset: .DistanceIcon), animatedImage: nil)
    ...
    public func bindToData(businessName: String, location: String, price: String, eta: Driver<String>) {
