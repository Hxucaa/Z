...
final class FeaturedListViewController: XUIViewController, UITableViewDelegate {
    typealias InputViewModel = (modelSelected: ControlEvent<BusinessInfo>, refreshTrigger: Observable<Void>, fetchMoreTrigger: Observable<Void>) -> IFeaturedListViewModel
    ...
    override func viewDidLoad() {
        ...
        dataSource.configureCell = { (_, tv, ip, info) in
            ...
            cell.detailTextLabel?.text = "sdfsdfsdfsdfsdf"
            return cell
        }
        ...
        let modelSelected = tableView.rx_modelSelected(BusinessInfo)
...
//    }
//    
//    func tableView(tableView: ASTableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> ASCellNode {
