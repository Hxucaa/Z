...
public struct NearbyViewModel : INearbyViewModel {
    ...
    */
    ...
    public func getBusinessesWithMap(centreLat: CLLocationDegrees, centreLong: CLLocationDegrees, radius: Double) -> SignalProducer<[NearbyTableCellViewModel], NSError> {
