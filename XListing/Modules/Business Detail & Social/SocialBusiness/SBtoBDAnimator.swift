...
//
//final class SBtoBDAnimator : NSObject, UIViewControllerAnimatedTransitioning {
//    
...
//    
//    init(startRect: CGRect, destination: CGPoint, headerView: SocialBusinessHeaderView, utilityHeaderView: SocialBusiness_UtilityHeaderView) {
