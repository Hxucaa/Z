...
//
//
//final class SocialBusinessViewModel : ISocialBusinessViewModel, ICollectionDataSource {
//    
...
//    
//    // MARK: Variables
//    weak var navigator: SocialBusinessNavigator!
//    
//    // MARK: - Initializers
//    init(dep: (meRepository: IMeRepository, businessRepository: IBusinessRepository, geoLocationService: IGeoLocationService, imageService: IImageService), business: Business) {
