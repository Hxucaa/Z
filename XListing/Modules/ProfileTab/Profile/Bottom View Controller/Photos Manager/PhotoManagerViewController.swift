...
final class PhotoManagerViewController : UIViewController {
...
//        view.registerClass(AddPhotoCollectionViewCell.self, forCellWithReuseIdentifier: AddPhotoCellIdentifier)
    ...
    private let indicatorInfo = IndicatorInfo(title: "照片")
...
//    func bindToViewModel(viewmodel: IPhotoManagerViewModel) {
//        self.viewmodel = viewmodel
//    }
    
    // Present an action sheet to choose between a profile picture
    func chooseProfilePictureSource() {
...
extension PhotoManagerViewController : IndicatorInfoProvider {
