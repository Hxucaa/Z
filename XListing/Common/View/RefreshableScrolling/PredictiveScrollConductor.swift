...
public func predictiveScrolling<T: UITableView, U: IPredictiveScrollable>(tableView: T, withVelocity velocity: CGPoint, #targetContentOffset: UnsafeMutablePointer<CGPoint>, #predictiveScrollable: U) {
