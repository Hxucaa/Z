...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/AVOSCloudCrashReportingDynamic/iOS/release-v3.1.3.6/AVOSCloudCrashReporting/Dynamic/AVOSCloudCrashReporting.framework"
  install_framework "${PODS_ROOT}/AVOSCloudDynamic/iOS/release-v3.1.3.6/AVOSCloud/Dynamic/AVOSCloud.framework"
  install_framework "${PODS_ROOT}/AVOSCloudIMDynamic/iOS/release-v3.1.3.6/AVOSCloudIM/Dynamic/AVOSCloudIM.framework"
